...
class NPC {
    ...
    constructor(id) {
        ...
        this.id = id;
        this.name = danganronpaNames[id % danganronpaNames.length]
		+ " #" + (id + 1);
...
function createNPCs(){
    ...
    for(let i = 0; i < NPC_COUNT; i++){
        ...
        // Spread them across the starting floor
...
function checkButtons(npc){
    ...
    for(const button of buttons){
        ...
        if(
            ...
            npc.x < button.x + button.width &&
            npc.x + npc.width > button.x &&

            npc.y + npc.height > button.y &&
            npc.y < button.y + button.height
